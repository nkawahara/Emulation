...
192.168.42.17    ${HOSTUSERBASE}17
192.168.42.18    ${HOSTUSERBASE}18
192.168.42.19    ${HOSTUSERBASE}19
192.168.42.20    ${HOSTUSERBASE}20
192.168.42.21    ${HOSTUSERBASE}21
192.168.42.22    ${HOSTUSERBASE}22
192.168.42.23    ${HOSTUSERBASE}23
192.168.42.24    ${HOSTUSERBASE}24
192.168.42.25    ${HOSTUSERBASE}25
192.168.42.26    ${HOSTUSERBASE}26
192.168.42.27    ${HOSTUSERBASE}27
192.168.42.28    ${HOSTUSERBASE}28
192.168.42.29    ${HOSTUSERBASE}29
192.168.42.30    ${HOSTUSERBASE}30
192.168.42.31    ${HOSTUSERBASE}31
192.168.42.32    ${HOSTUSERBASE}32
...
set -u
[ "$NODES" -lt 1 -o "$NODES" -gt 32 ] && die "'$1' VMs is not in range 1-32"
